...
public class FlightService {
   ...
   */
  public static String execute(QueryAbstract q, String command) throws SQLException {
   ...
   * @throws IOException
   */
  private static void menu(QueryAbstract q) throws IOException, SQLException {
    while (true) {
