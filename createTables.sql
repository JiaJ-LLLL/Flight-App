...
CREATE TABLE Users_jl362 (
    username VARCHAR(20) PRIMARY KEY,
    password_hash_salt VARBINARY(256),
    balance INT NOT NULL
);

CREATE TABLE Reservations_jl362 (
    rid INT PRIMARY KEY,
    paid BIT NOT NULL, -- 1 means paid, 0 means unpaid
    flight1 INT REFERENCES Flights,
    flight2 INT REFERENCES Flights,
    user_name VARCHAR(20) REFERENCES Users_jl362,
    date INT,
    price INT
);